...
!function (a, b) {
    ...
    var q = "3.0.0 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector,-deprecated",
        r = function (a, b) {
    ...
    var Za = /^(?:input|select|textarea|button)$/i, $a = /^(?:a|area)$/i;
    r.fn.extend({
        prop: function (a, b) {
    ...
    r.fn.extend({
        addClass: function (a) {
            ...
            if ("string" == typeof a && a) {
                b = a.match(K) || [];
                while (c = this[i++]) if (e = ab(c), d = 1 === c.nodeType && (" " + e + " ").replace(_a, " ")) {
                    g = 0;
            ...
            var b, c, d = 0;
            b = " " + a + " ";
            while (c = this[d++]) if (1 === c.nodeType && (" " + ab(c) + " ").replace(_a, " ").indexOf(b) > -1) return !0;
            return !1
        }
    });
    var bb = /\r/g, cb = /[\x20\t\r\n\f]+/g;
    ...
    function ib(a, b, c, d) {
        ...
        }); else if (c || "object" !== r.type(b)) d(a, b); else for (e in b) ib(a + "[" + e + "]", b[e], c, d)
    }
